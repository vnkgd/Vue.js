          ...
          <div class="post__container">
              ...
              <div class="articles__filters">
                  <div id="tag-buttons">
                    ...
                    <button v-for="tag in tags" @click="filterArticles(tag)" :key="tag" class="articles__filter">{{ tag }}</button>
                  </div>
              </div>
              <div class="post__container">
                  <div class="post__item item-post" v-for="article in filteredArticles" :key="article.id">
